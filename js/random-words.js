function famousWords() {
    ...
    `;
    document.querySelector('.row.justify-content-center').appendChild(wordsSelectArea);
    ...
    buttons.forEach(function(button) {
        button.addEventListener('click', function(event) {
            ...
            `;
            document.querySelector('.row.justify-content-center').appendChild(famousWordContainer);
            ...
            addButton.addEventListener('click', function(event) {
                ...
                if (name) {
                    ...
                    document.querySelector('.row.justify-content-center').appendChild(additionalInputArea);
                    if (button === buttons[3]) {
                        document.querySelector('.row.justify-content-center').appendChild(wordWithNameContainer3);
                    } else {
                        document.querySelector('.row.justify-content-center').appendChild(wordWithNameContainer1);
                        document.querySelector('.row.justify-content-center').appendChild(wordWithNameContainer2);
                        document.querySelector('.row.justify-content-center').appendChild(wordWithNameContainer3);
                        document.querySelector('.row.justify-content-center').appendChild(wordWithNameContainer4);
                    }
